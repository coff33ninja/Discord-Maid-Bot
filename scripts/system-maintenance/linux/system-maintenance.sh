#!/bin/bash
#
# System Maintenance Script for Linux
# 
# Automatically updates and upgrades system packages with network connectivity checks
# and retry logic. Schedules reboot if required.
#
