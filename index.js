...
client.on('interactionCreate', async (interaction) => {
  if (interaction.isAutocomplete()) {
    ...
    try {
      ...
      // Plugin command autocomplete handled by dynamic router above
  ...
  try {
    ...
    // /automation router
      ...
      // Plugin commands (speedalert, devicetrigger, health) handled by dynamic router above
    }
    ...
    // Plugin commands (speedalert, devicetrigger, health) handled by dynamic plugin system above
